...
module.exports = async (req, res) => {
  ...
  const navDashboardClass = "sidebar-link";
  const pageTitle = "Space | Contratos";
          ...
          <header class="growth-v2-header growth-contracts-header" aria-label="Cabeçalho de contratos">
            ...
            <div class="growth-v2-head-right growth-contracts-head-right" aria-label="Ações">
              ...
              <div class="growth-v2-usercard">
                ...
                <div class="growth-v2-user-feedback" data-growth-avatar-feedback hidden></div>
              </div>
              <div class="growth-v2-avatar-wrap">
                <button class="growth-v2-avatar growth-v2-avatar-button" type="button" data-growth-avatar-trigger aria-label="Alterar foto de perfil">
                  <span data-growth-avatar>GR</span>
                </button>
                <span class="growth-v2-avatar-edit" data-growth-avatar-edit aria-hidden="true">✎</span>
                <input type="file" hidden accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp" data-growth-avatar-file />
              </div>
            </div>
          </header>
