...
<html lang="pt-BR">
  ...
  <body data-view="interno" data-page="growth">
    ...
    <main class="growth-shell" aria-label="Painel Growth">
      <header class="growth-header">
        ...
        <div class="growth-head-right">
          ...
          <button class="growth-logout" type="button" data-growth-logout>Sair</button>
        </div>
      </header>
