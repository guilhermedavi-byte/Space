...
test('Agenda uses official embed and opaque server context; browser accepted status cannot confirm',async t=>{
 ...
 const form=w.document.querySelector('[data-agenda-contact]');form.elements.name.value='Test Contact';form.elements.attendeePhoneNumber.value='+5534999569129';form.dispatchEvent(new w.Event('submit',{cancelable:true}));
